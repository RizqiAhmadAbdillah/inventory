            ...
            <div class="col-12">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body row">
                        ...
                        <div class="col-9">
                            <dl class="row">
                                <dt class="col-sm-2">Nama barang</dt>
                                <dd class="col-sm-10"><?= $barang['nama_barang']; ?></dd>
                                <dt class="col-sm-2">Jenis barang</dt>
                                <dd class="col-sm-10"><?= $barang['nama_jenis_barang']; ?></dd>
                                <dt class="col-sm-2">Deskripsi</dt>
                                <dd class="col-sm-10"><?= $barang['deskripsi_barang']; ?></dd>
                                <dt class="col-sm-2">Jumlah</dt>
                                <dd class="col-sm-10"><?= $barang['deskripsi_barang']; ?></dd>
                                <dt class="col-sm-2">Cabang</dt>
                                <dd class="col-sm-10"><?= $barang['nama_cabang']; ?></dd>
                            </dl>
